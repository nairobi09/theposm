...
namespace thepos
{
    internal class paymentKCP
    {
        ...
        public int requestKcpCashCancel(PaymentCash pCash, out PaymentCash pCashCancel)
        {
            pCashCancel = pCash;
            ...
            clsSecureDLL.SetData("TRAN_NO", pCash.tran_serial);

            clsSecureDLL.SetData("TOT_AMT", pCash.amount + "");

            clsSecureDLL.SetData("CANCEL_CD", "1");


            clsSecureDLL.SetData("OTX_DT", pCash.tran_date.Substring(0, 6));

            clsSecureDLL.SetData("AUTH_NO", pCash.auth_no);
